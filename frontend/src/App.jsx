...
const DocumentScannerPage = lazy(() => import('./pages/DocumentScannerPage'))
...
function AppToaster() {
  ...
  return (
    <Toaster
      ...
      gutter={10}
      containerStyle={{ bottom: 22, left: 18, right: 18 }}
      toastOptions={{
        duration: 3200,
        style: {
          background: 'var(--bg2)',
              ...
              <BrowserRouter basename={basename}>
                <Suspense fallback={<PageLoader title="Chargement" detail="Preparation de la page..." />}>
                  ...
                  <Route path="/" element={<RequireAuth><Layout /></RequireAuth>}>
                    ...
                    <Route path="document-scanner" element={protectedPage('document-scanner', <DocumentScannerPage />)} />
                    <Route path="research" element={protectedPage('research', <ResearchPage />)} />
