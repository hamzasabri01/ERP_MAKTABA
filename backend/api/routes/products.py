...
EXPORT_COLUMNS = [
    ...
    "sale_unit", "sale_to_base_factor", "sale_unit_price",
...
HEADER_ALIASES = {
    ...
    "sale_unit": "sale_unit",
    "unite_vente_secondaire": "sale_unit",
    "sale_to_base_factor": "sale_to_base_factor",
    "contenu_unite_vente": "sale_to_base_factor",
    "sale_unit_price": "sale_unit_price",
    "prix_unite_vente": "sale_unit_price",
...
def import_products(file: UploadFile = File(...), db: Session = Depends(get_db), user=Depends(get_current_user)):
    ...
    for index, row in enumerate(rows, start=2):
        ...
        data = {
            ...
            "sale_unit": _clean(row.get("sale_unit")),
            "sale_to_base_factor": _decimal(row.get("sale_to_base_factor"), Decimal("1"), kind="stock_quantity") or Decimal("1"),
            "sale_unit_price": _decimal(row.get("sale_unit_price"), Decimal("0"), kind="sale_price"),
